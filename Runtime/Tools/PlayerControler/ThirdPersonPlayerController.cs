...
namespace NonsensicalKit.Tools.PlayerController
{
    ...
    public class ThirdPersonPlayerController : NonsensicalMono
    {
        ...
        /// 控制是否能够控制移动和旋转
        /// </summary>
        public bool CanControl { set { _canMove = value; _canRotate = value; } }
        ...
        /// 水平位移输入移动幅度
        /// </summary>
        protected float _inputMagnitude;
        /// <summary>
        /// 角色是否接地
        /// </summary>
        ...
        private void GroundedCheck()
        {
            ...
            _grounded = Physics.CheckSphere(spherePosition, m_groundedRadius, m_groundLayers,
            ...
            if (_canRotate)
            {
                ...
                switch (m_rotateControlType)
                {
                    case RotateControlType.OnMouseLeftButtonHold:
                        controlCameraRotate = _input.IsMouseLeftButtonHold;
                        break;
                    case RotateControlType.OnMouseRightButtonHold:
                        controlCameraRotate = _input.IsMouseRightButtonHold;
                        break;
                    default:
        ...
        private void Move()
        {
            ...
            _inputMagnitude = _input.CrtMove.magnitude;
                ...
                currentHorizontalSpeed > targetSpeed + speedOffset)
            {
                ...
                _horizontalVelocity = Mathf.Lerp(currentHorizontalSpeed, targetSpeed * _inputMagnitude,
                    Time.deltaTime * m_speedChangeRate);

                // round speed to 3 decimal places
                _horizontalVelocity = Mathf.Round(_horizontalVelocity * 1000f) / 1000f;
            }
            else
            {
                _horizontalVelocity = targetSpeed;
            }
            ...
            // move the player
            _controller.Move(targetDirection.normalized * (_horizontalVelocity * Time.deltaTime) +
